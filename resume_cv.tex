...
\name{Gustavo}{de Oliveira Vital}
\address{Rua Cel. Moreira Cesar 300 apto 603, Niterói, RJ, Brasil}
\mobile{+55 21 9 8366-9001}
...
\position{Economista} % Your expertise/fields

\makecvfooter{\today}{Gustavo de Oliveira Vital~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
